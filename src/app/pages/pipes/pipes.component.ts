...
import { CommonModule, DatePipe, CurrencyPipe, UpperCasePipe, LowerCasePipe, TitleCasePipe, JsonPipe, SlicePipe, PercentPipe, DecimalPipe } from '@angular/common';
...
export class PipesComponent {
	...
	longText = 'Angular Pipes là một tính năng mạnh mẽ để transform data trong templates. Pipes giúp format và hiển thị dữ liệu một cách dễ dàng và có thể tái sử dụng.';
